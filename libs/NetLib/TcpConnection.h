...
namespace net
{
	...
	class EVENTLOOP_EXPORT TcpConnection : public std::enable_shared_from_this<TcpConnection>
	{
	public:
        ...
        void setErrorMegCallBack(const ErrorMessageCallBack&cb) { m_errorCallbackCB = cb; }
