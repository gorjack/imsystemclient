#ifndef __CUSERCENTERCENTER__
#define __CUSERCENTERCENTER__
...
class USER_EXPORT CUserClientCenter : public QObject, public utils::CSingletonT<CUserClientCenter>
{
    Q_OBJECT
public:
    CUserClientCenter();
...
private:
    CUserClientCenter(const CUserClientCenter&) = delete;
    CUserClientCenter& operator=(const CUserClientCenter&) = delete;
