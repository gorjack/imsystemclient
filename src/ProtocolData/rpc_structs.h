...
namespace net
{
    ...
    {
    public:
        CFontInfo(void) : m_nSize(9), m_clrText(""), m_strName(("微软雅黑")),
    ...
    public:
        std::string    m_strName;			// 接收自定义表情使用参数(TODO: 这个字段先保留，不要用，留作以后扩展)
