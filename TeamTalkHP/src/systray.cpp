...
{
	setToolTip(QStringLiteral("QQ-雨田哥"));
...
void SysTray::addSysTrayMenu()
{
	...
	customMenu->addCustomMenu("onShow", ":/TeamTalkHP/Resources/MainWindow/app/face_setting_btn_normal.png", QStringLiteral("设置"));
	customMenu->addSeparator();
	customMenu->addCustomMenu("onQuit", ":/TeamTalkHP/Resources/MainWindow/app/page_close_btn_hover.png", QStringLiteral("退出"));
